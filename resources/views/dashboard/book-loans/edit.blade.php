                                    ...
                                    <div class="card card-bordered card-preview">
                                        <div class="card-inner">
                                            ...
                                            <div class="preview-block">
                                                ...
                                                <form action="{{route('dashboard.book.loans.update', ['id' => encrypt_id($bookLoan->id)])}}" method="post" id="myForm">
                                                    @csrf
                                                    @method('put')
                                                    <div class="row gy-4">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <select class="form-select js-select2" data-search="on" name="book_id">
                                                                        ...
                                                                        <option value="{{ encrypt_id($book->id) }}" @selected($bookLoan->book_id === $book->id)>{{ $book->title }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                @error('book_id')
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <select class="form-select js-select2" data-search="on" name="borrower_id">
                                                                        ...
                                                                        <option value="{{ encrypt_id($borrower->id) }}" @selected($bookLoan->borrower->id === $borrower->id)>{{ $borrower->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                @error('borrower_id')
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="date" class="form-control" name="loan_date" value="{{$bookLoan->loan_date}}">
                                                                </div>
                                                            </div>
                                                            @error('loan_date')
                                                                    <span class="error-message">{{ $message }}</span>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="date" class="form-control" name="due_date" value="{{$bookLoan->due_date}}">
                                                                </div>
                                                            </div>
                                                            @error('due_date')
                                                                    <span class="error-message">{{ $message }}</span>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea class="form-control no-resize" id="notes" name="notes">{{ $bookLoan->notes }}</textarea>
                                                                </div>
                                                                @error('notes')
                                                                    <span class="error-message">{{ $message }}</span>
                                                                @enderror
