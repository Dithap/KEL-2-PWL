                                                        ...
                                                        <div class="card product-card">
                                                            <div class="product-thumb">
                                                                <a href="{{route('dashboard.books.show', ['id' => encrypt_id($book->id)])}}">
                                                                    <img class="card-img-top" src="{{asset('storage/books/'.$book->cover_image)}}" alt="">
                                                                </a>
                                                            ...
                                                            <div class="card-inner text-center">
                                                                ...
                                                                <div class="product-price text-primary h5" style="display: flex; justify-content: center;">
                                                                    <div style="width: 45%; margin-right: 2px;">
                                                                        <a href="{{route('dashboard.book.loans.create', ['book' => encrypt_id($book->id)])}}" class="btn {{$book->quantity_total > 0 ? 'btn-warning' : 'btn-light'}} w-100 d-flex justify-content-center">Pinjam</a>
                                                                    </div>
                                                                    <div style="width: 45%; margin-left: 2px;">
