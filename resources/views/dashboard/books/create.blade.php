                                    ...
                                    <div class="card card-bordered card-preview">
                                        <div class="card-inner">
                                            ...
                                            <div class="preview-block">
                                                ...
                                                <form action="{{route('dashboard.books.store')}}" method="post" id="myForm" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row gy-4">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="title" placeholder="Contoh: Psikologi Perkembangan Anak" name="title" value="{{ old('title') }}">
                                                                </div>
                                                                @error('title')
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="author" placeholder="Contoh: Dr. Aulia Rahman" name="author" value="{{ old('author') }}">
                                                                </div>
                                                                @error('author')
                                                                    <span class="error-message">{{ $message }}</span>
                                                                @enderror
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="publisher" placeholder="Contoh: Gramedia Pustaka Utama" name="publisher" value="{{ old('publisher') }}">
                                                                </div>
                                                                @error('publisher')
                                                                    <span class="error-message">{{ $message }}</span>
                                                                @enderror
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="year" placeholder="Contoh: 2023" name="year" value="{{ old('year') }}">
                                                                </div>
                                                                @error('year')
                                                                    <span class="error-message">{{ $message }}</span>
                                                                @enderror
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <select class="form-select js-select2" data-search="on" name="category_id">
                                                                        ...
                                                                        <option value="{{ encrypt_id($category->id) }}" @selected(old('category_id') && $category->id === decrypt_id(old('category_id')))>{{ $category->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                @error('category_id')
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="isbn" placeholder="Contoh: 978-623-1234-567-8" name="isbn" value="{{ old('isbn') }}">
                                                                </div>
                                                                @error('isbn')
                                                                    <span class="error-message">{{ $message }}</span>
                                                                @enderror
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="language" placeholder="Contoh: Indonesia" name="language" value="{{ old('language') }}">
                                                                </div>
                                                                @error('language')
                                                                    <span class="error-message">{{ $message }}</span>
                                                                @enderror
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="quantity_total" placeholder="Contoh: 13" name="quantity_total" value="{{ old('quantity_total') }}">
                                                                </div>
